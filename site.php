...
if(isset($_POST['modelo'])){
    ...
    $modelo = new Modelo($nome, $rua, $porta, $codPostal, $cidade, $pais, $contacto, $nif, $sexo, $nacionalidade,$altura, $medida1,$medida2,$medida3,0);
...
if(isset($_POST['agente'])){
    ...
    $agente = new Agente($nome, $rua, $porta, $codPostal, $cidade, $pais, $contacto, $nif, $dataInicio);
...
if(isset($_POST['fotografo'])){
    ...
    $fotografo = new Fotografo($nome, $rua,$porta,$codPostal, $cidade, $pais, $contacto, $nif, $dataInicio);
